...
import ReportTable from '../ReportTable/ReportTable';  // Import the Table component
import ReportModal from '../ReportModal/ReportModal';  // Importing the Modal component
